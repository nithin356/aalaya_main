...
echo '<div class="data-card"><div class="card-header"><h2>Transaction Tables Hidden</h2></div><div style="padding:24px; color: var(--text-muted);">Share transaction tables are currently hidden.</div></div>';
