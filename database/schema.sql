...
CREATE TABLE IF NOT EXISTS users (
    ...
    investment_shares INT DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS invoices (
    ...
    status ENUM('pending', 'paid', 'cancelled', 'pending_verification') DEFAULT 'pending',
    payment_id VARCHAR(100),
    manual_utr_id VARCHAR(100) DEFAULT NULL,
    manual_payment_screenshot VARCHAR(255) DEFAULT NULL,
    payment_method ENUM('cashfree', 'manual') DEFAULT 'cashfree',
